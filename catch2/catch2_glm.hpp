...
namespace Catch {
    ...
    struct StringMaker<glm::vec<N, genType>> {
        static std::string convert(glm::vec<N, genType> const& value ) {
    ...
    struct StringMaker<glm::mat<N, N, genType>> {
        static std::string convert(glm::mat<N, N, genType> const& value) {
            return glm::to_string( value );
        }
    };
    ...
    struct StringMaker<glm::tquat<genType>> {
        static std::string convert(glm::tquat<genType> const& value) {
            return glm::to_string( value );
        }
    };
}
